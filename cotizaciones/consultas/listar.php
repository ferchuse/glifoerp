<?php 
	...
	*
	...
	if($_GET["id_clientes"] != ""){
		...
		$consulta.="AND cotizaciones.id_clientes = '{$_GET["id_clientes"]}'";
		
	}
	
	
	$consulta.=" ORDER BY id_cotizaciones DESC ";
...
<table class="table table-hover table-condensed table-bordered">
	...
	<?php 
		...
		<tr class="text-center">
			...
			<td><?php echo date("d/m/Y", strtotime($fila["fecha_cotizaciones"]));?></td>
			...
			<td>
				<a href="imprimir_cotizacion.php?id_registro=<?php echo $fila["id_cotizaciones"];?>" class="btn btn-sm btn-info btn_imprimir" target="_blank" 
				>
				...
				<a href="nueva_venta.php?tipo_movimiento=VENTA&tabla=ventas&folio_ventas=<?php echo $fila["id_cotizaciones"]?>" class="btn btn-sm btn-warning " type="button" 
